...
--
-- Data for Name: asset_format_item; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.asset_format_item (asset_format_item_code, geol_code, name, name_de, name_fr, name_it, name_en, description, description_de, description_fr, description_it, description_en) FROM stdin;
...
--
-- Data for Name: asset_kind_item; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.asset_kind_item (asset_kind_item_code, geol_code, name, name_de, name_fr, name_it, name_en, description, description_de, description_fr, description_it, description_en) FROM stdin;
...
--
-- Data for Name: contact_kind_item; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.contact_kind_item (contact_kind_item_code, geol_code, name, name_de, name_fr, name_it, name_en, description, description_de, description_fr, description_it, description_en) FROM stdin;
...
--
-- Data for Name: language_item; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.language_item (language_item_code, geol_code, name, name_de, name_fr, name_it, name_en, description, description_de, description_fr, description_it, description_en) FROM stdin;
EN	No-GeolCode-specified	english	englisch	anglais	inglese	english	Asset in English	Asset in Englisch	Asset en anglais	Asset in inglese	Asset in English
IT	No-GeolCode-specified	italian	italienisch	italien	italiano	italian	Asset in Italian	Asset in Italienisch	Asset en italien	Elemento in italiano	Asset in Italian
FR	No-GeolCode-specified	french	französisch	français	francese	french	Asset in French	Asset in Französisch	Asset en français	Elemento in francese	Asset in French
DE	No-GeolCode-specified	german	deutsch	allemand	tedesco	german	Asset in German	Asset in Deutsch	Asset en allemand	Elemento in tedesco	Asset in German
other	No-GeolCode-specified	other languages	andere Sprachen	autres langues	altre lingue	other languages	Asset in other languages	Asset in anderer Sprachen	Assets dans d'autres langues	Elemento in altre lingue	Asset in other languages
...
--
-- Data for Name: man_cat_label_item; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.man_cat_label_item (man_cat_label_item_code, geol_code, name, name_de, name_fr, name_it, name_en, description, description_de, description_fr, description_it, description_en) FROM stdin;
