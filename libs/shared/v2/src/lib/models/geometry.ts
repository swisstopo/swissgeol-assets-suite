...
export const mapStudyTagToGeometryType = (tag: 'Point' | 'LineString' | 'Polygon'): GeometryType => {
  if (tag === 'LineString') {
    return GeometryType.Line;
  }
  return tag as GeometryType;
};

export const mapGeometryTypeToStudyTag = (type: GeometryType): 'Point' | 'LineString' | 'Polygon' => {
