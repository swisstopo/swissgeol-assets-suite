...
export const searchByFilterConfiguration = createAction('[Asset Search] Search by filter configuration', props<{
  filterConfiguration: AssetSearchQuery
}>());
export const getStats = createAction('[Asset Search] Get Stats');
export const updateStats = createAction('[Asset Search] Update search stats', props<{
  searchStats: AssetSearchStats
}>());
export const search = createAction('[Asset Search] Search');
export const updateSearchResults = createAction('[Asset Search] Update search results', props<{
...
export const searchForAssetDetail = createAction('[Asset Search] Search for asset detail', props<{
  assetId: number
}>());
export const updateAssetDetail = createAction('[Asset Search] Update Asset Detail', props<{
