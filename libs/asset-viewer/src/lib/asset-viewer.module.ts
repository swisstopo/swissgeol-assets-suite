...
import { AssetSearchEffects } from './state/asset-viewer.effects';
import { assetViewerReducer } from './state/asset-viewer.reducer';
...
@NgModule({
    ...
    imports: [
        ...
        StoreModule.forFeature('assetViewer', assetViewerReducer),
