import { AssetId, Geometry, GeometryAccessType, GeometryId, WorkgroupId } from '@asset-sg/shared/v2';
...
export class GeometryRepo implements ReadRepo<Geometry, GeometryId> {
  ...
  list({ limit, offset, ids, workgroupIds, assetIds }: ListOptions = {}): Promise<Geometry[]> {
