...
export const rmAppTranslations: AppTranslations = {
    ...
    search: {
        ...
        searchInstructions:
            'RM Suche nach einem Asset über das Suchfeld oder durch Zeichnen eines Polygons auf der Karte.',
        ...
        assetsUnderMouseCursor:
            'RM {{ assetsCount }} Assets unter dem Mauszeiger gefunden. Bitte wählen Sie eines aus:',
