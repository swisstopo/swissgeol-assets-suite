...
export const itTranslationMapping: AppTranslationMapping = {
  ...
  search: {
    ...
    format: 'IT Format',
    date: 'IT Datum',
    documents: 'IT Dokumente',
    legalDocuments: 'IT Rechtliche Einwilligungen',
    createdDate: 'IT Erstellungsdatum',
    receiptDate: 'IT Eingangsdatum',
    lastProcessedDate: 'IT Letztes Update',
    alternativeId: 'IT Alternativ-ID',
    alternativeIdDescription: 'IT Beschreibung',
    contacts: 'IT Kontakte',
    subject: 'IT Thema',
    content: 'IT Inhalt',
    nationalInterest: 'IT Nat. Interesse',
    references: 'IT Verweise',
    status: 'IT Status',
