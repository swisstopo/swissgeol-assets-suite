...
export const fakeManCatLabelItemCode = (): string => faker.helpers.arrayElement(
    manCatLabelItems.map((item) => item.manCatLabelItemCode),
);
...
export const manCatLabelItems: ManCatLabelItem[] = [
    {
        ...
        descriptionFr: 'Assets sur le thème des géoénergies, p. ex. géothermie, matières premières énergétiques (pétrole, gaz naturel, charbon), etc.',
        descriptionRm: '',
        descriptionIt: 'Elementi sul tema della geoenergia, ad esempio energia geotermica, risorse energetiche (petrolio, gas, carbone), ecc.',
    ...
    },
    {
        ...
        descriptionFr: 'Assets sur le thème des ressources minérales (y compris exploitation minière, carrières, gravières, etc.)',
        descriptionRm: '',
